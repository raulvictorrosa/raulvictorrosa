...
export const personalInfo = {
  ...
  bio: "Hi! I'm Raul Victor Rosa, a passionate Frontend Developer specializing in React with over 8 years of experience building modern web applications. Currently working at Bosch Portugal on the PRO360 suite, I previously contributed to Vodafone's V-Hub platform at Capgemini Engineering, serving 5M+ users across Europe and Africa. I excel at transforming designs into pixel-perfect, accessible components and optimizing application performance. Always eager to learn, I'm currently expanding my skills into Rust and backend development.",
  social: {
...
export const experiences: ExperienceType[] = [
  {
    ...
    company: {
      name: 'Bosch Portugal',
      url: 'https://www.linkedin.com/company/bosch-portugal',
    },
    contract: 'Full-time',
    ...
    endDate: 'Present',
    description: [
      'Currently working on PRO360 and DIY projects within the Bosch ecosystem',
      'Developing intuitive interfaces for PRO360 platform for efficient inventory and operations management',
      'Building user-centric solutions for DIY enthusiasts with enhanced user experience',
      'Designing and implementing responsive user interfaces using React',
      'Ensuring seamless integration with backend services and optimizing application performance',
      'Previously contributed to PRO360 Inventory, PRO360 Backoffice, and PRO Deals',
    ],
    skills: ['React', 'TypeScript', 'Next.js', 'JavaScript', 'REST APIs', 'Git', 'Agile'],
  },
  {
    title: 'Advanced Technician React Developer',
    company: {
      name: 'Capgemini Engineering',
      url: 'https://www.linkedin.com/company/72092703/',
    },
    contract: 'Full-time',
    location: 'Lisbon, Portugal (Remote)',
    startDate: 'Jan 2022',
    endDate: 'Mar 2023',
    description: [
      "Developed Vodafone's V-Hub platform—a digital advisory service for SMEs",
      'Created interactive and responsive web components using React',
      'Ensured accessibility and performance optimization across devices and browsers',
      'Delivered user-friendly experiences for over 5 million users across Europe and Africa',
      'Worked with cross-functional teams to deliver digital transformation solutions',
    ],
    skills: ['React', 'JavaScript', 'TypeScript', 'REST APIs', 'Accessibility', 'Git', 'Agile'],
  },
  {
    title: 'React Developer',
    company: {
    ...
    description: [
      ...
      'Integrated Web3 libraries for cryptocurrency transaction functionality in NFT projects',
